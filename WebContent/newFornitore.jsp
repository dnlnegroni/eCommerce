	...
	<div align="center" style="border: 1px; border-color: black">
		<form class="form-inline" action="<c:url value="/controller/fornitore.create" />" method="get">
			<table >
				<tr>
					<td>
						Piva: <input type="text" class="form-control" name="partitaIva" value="${param.partitaIva}"/>
					</td>
				</tr>
				<tr>
					<td>
						Telefono: <input type="text" class="form-control" name="telefono" value="${param.telefono}"/>
					</td>
				</tr>
				<tr>
					<td>
						Indirizzo: <input type="text" class="form-control" name="indirizzo" value="${param.indirizzo}"/>
					</td>
				</tr>
				<tr>
					<td>
						Email: <input type="text" class="form-control" name="email" value="${param.email}"/>
					</td>
				</tr>
				<tr align="right">
					<td>
